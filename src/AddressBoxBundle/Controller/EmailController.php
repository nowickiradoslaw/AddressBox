...
use AddressBoxBundle\Entity\Email;
...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emails = $em->getRepository('AddressBoxBundle:Email')->findAll();
    ...
    {
        $email = new Email();
        $form = $this->createForm('AddressBoxBundle\Form\EmailType', $email);
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('AddressBoxBundle\Form\EmailType', $email);
